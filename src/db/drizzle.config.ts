...
const user = process.env.SQL_ADMIN_USER || process.env.SQL_USER || process.env.POSTGRES_USER || 'lifehub';
const password = process.env.SQL_ADMIN_PASSWORD || process.env.SQL_PASSWORD || process.env.POSTGRES_PASSWORD || 'lifehub_secret_pass';
